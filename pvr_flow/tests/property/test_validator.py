...
def test_validator_valid_payload(alert_id, service, severity, message, host, triggered_at):
    payload = {
        "alert_id": alert_id,
        "service": service,
        "severity": severity,
...
def test_validator_invalid_severity(alert_id, service, severity, message, host, triggered_at):
    payload = {
        "alert_id": alert_id,
        "service": service,
        "severity": severity,
